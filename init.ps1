...
Write-Host "Preparing your Sitecore Containers environment! '$Topology'" -ForegroundColor Green
...
try {
    ...
    & $mkcert -install
    & $mkcert "*.mysitecoreproject.localhost"
}
catch {
...
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.mysitecoreproject.localhost"
}
Add-HostsEntry "cm.mysitecoreproject.localhost"
Add-HostsEntry "id.mysitecoreproject.localhost"
Add-HostsEntry "www.mysitecoreproject.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.mysitecoreproject.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.mysitecoreproject.localhost"
    }


    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.mysitecoreproject.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.mysitecoreproject.localhost"

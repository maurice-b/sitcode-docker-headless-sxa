...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.mysitecoreproject.localhost/ --auth https://id.mysitecoreproject.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.mysitecoreproject.localhost/ --auth https://id.mysitecoreproject.localhost/ --allow-write true
}
...
Start-Process https://cm.mysitecoreproject.localhost/sitecore/
Start-Process https://www.mysitecoreproject.localhost/
